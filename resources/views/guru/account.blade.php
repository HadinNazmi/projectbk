...
<div class="hero hero-spaced">
    <div class="hero-left">
        ...
        <p>Password awal menggunakan NIP. Guru dapat menggantinya kapan saja.</p>
    </div>
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('guru.account.password') }}" method="POST">
            @csrf
            @method('PATCH')
            ...
            <div class="btn-row">
                ...
                <a href="{{ route('guru.dashboard') }}" class="btn btn-outline">Kembali</a>
            </div>
        </form>
    </div>
</div>
...
<div class="card">
    ...
    <div class="card-body status-body">
        ...
        @else
            Password masih menggunakan NIP awal.
        @endif
    </div>
</div>
@endsection
